...
void one(const char *grade) {
    float fgrade = strtof(grade, NULL);
...
void six(const char *str) {
    char *s = "Hello ";
    char *res = malloc(strlen(s) + strlen(str) + 1);
    res = strcpy(res, s);
    res = strcat(res, str);
    printf("%s\n", res);
    free(res);
 ...
 *
 * Examples:
 *    clear_bits(value = 0xFF, flag = 0x55): 0xAA -----> 1111 1111, 0101 0101 => 1010 1010
 *    clear_bits(value = 0x00, flag = 0xF0): 0x00 -----> 0000 0000, 1111 0000 => 0000 0000
 *    clear_bits(value = 0xAB, flag = 0x00): 0xAB -----> 1010 1011, 0000 0000 => 1010 1011
 *
 * @param value
